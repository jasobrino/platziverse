...
test.serial('Setup', t => {
  ...
  t.true(AgentStub.hasMany.calledWith(MetricSub), 'Argument should be the MetricModel')
  t.true(MetricSub.belongsTo.called, 'MetricModel.belongsTo was executed')
  t.true(MetricSub.belongsTo.calledWith(AgentStub), 'Argument should be the AgentModel')
})
...
test.serial('Agent#createOrUpdate - new', async t => {
  ...
  t.true(AgentStub.create.calledWith(newAgent), 'create should be called whith specified agent')
...
test.serial('Agent#findByUsername', async t => {
  ...
  t.is(agents.length, agentFixtures.platzi.length, 'agents should be - length ')
...
test.serial('Agent#findConnected', async t => {
  ...
  t.is(agents.length, agentFixtures.connected.length, 'agents should be - length ')
